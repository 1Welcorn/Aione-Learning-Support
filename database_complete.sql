...
CREATE POLICY "Acesso Total" ON units FOR ALL USING (auth.jwt() ->> 'email' IN ('willians.souza@escola.pr.gov.br', 'ione.ribeiro@escola.pr.gov.br'));

DROP POLICY IF EXISTS "Acesso Total" ON sessions;
CREATE POLICY "Acesso Total" ON sessions FOR ALL USING (auth.jwt() ->> 'email' IN ('willians.souza@escola.pr.gov.br', 'ione.ribeiro@escola.pr.gov.br'));

DROP POLICY IF EXISTS "Acesso Total" ON answers;
CREATE POLICY "Acesso Total" ON answers FOR ALL USING (auth.jwt() ->> 'email' IN ('willians.souza@escola.pr.gov.br', 'ione.ribeiro@escola.pr.gov.br'));

DROP POLICY IF EXISTS "Acesso Total" ON settings;
CREATE POLICY "Acesso Total" ON settings FOR ALL USING (auth.jwt() ->> 'email' IN ('willians.souza@escola.pr.gov.br', 'ione.ribeiro@escola.pr.gov.br'));
